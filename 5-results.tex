...
\begin{figure}[htbp]
 ...
 \caption{Optimal semi-major axis as a function of the number of spacecraft in the system. The eccentricity is zero, and the spacecraft are spread out equally. All values were optained using surrogate optimization.}
